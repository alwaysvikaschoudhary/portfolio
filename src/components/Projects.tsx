...
const projects = [
  ...
  {
    name: 'DevSync IDE',
    tagline: 'Cloud-based Collaborative Editor',
    description:
      'A powerful cloud IDE supporting real-time collaboration, syntax highlighting for 50+ languages, and integrated terminal.',
    bullets: [
      'Real-time collaborative editing using CRDTs for seamless multi-user interaction.',
      'Integrated sandboxed terminal for code execution and testing.',
      'File system abstraction for project management and cloud storage.',
    ],
    tech: ['Node.js', 'Socket.io', 'Monaco Editor', 'Docker'],
    github: '#',
    demo: '#',
    accent: 'cyan',
  },
  {
    ...
    tagline: 'Comprehensive Health & Fitness',
    description:
      'A holistic health tracking application that monitors vitals, activity levels, and nutrition with personalized insights and goal setting.',
    bullets: [
      'Detailed activity tracking with GPS integration for outdoor workouts.',
      'Nutrition logging with extensive food database and macronutrient breakdown.',
      'AI-driven health insights based on historical data and user goals.',
    ],
    tech: ['React Native', 'Firebase', 'Redux', 'Google Fit API'],
    github: '#',
    demo: '#',
    accent: 'purple',
  },
              ...
              {visibleProjects.map((project, index) => {
                ...
                return (
                  <div
                    ...
                    className={`${isCyan ? 'card-glow' : 'card-glow-purple'} rounded-2xl p-8 md:p-12 flex flex-col h-full max-w-4xl w-full shadow-2xl transition-all duration-500`}
                  >
                    {/* Project header */}
                    ...
                    <div
                      ...
                      style={{ height: '1px', background: `linear-gradient(90deg, transparent, ${accentColor}, transparent)` }}
                    />
                    ...
                    <ul className="space-y-4 mb-10 flex-1">
                      {project.bullets.map((bullet, bi) => (
                        ...
                        >
                          <span
                            className="flex-shrink-0 mt-1.5 w-2 h-2 rounded-full shadow-[0_0_8px_rgba(0,224,202,0.5)]"
